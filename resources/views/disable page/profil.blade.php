...
<head>
  ...
  <style>
    ...
    @media (max-width: 640px) {
      ...
      /* Top nav lebih rapat */
      header nav.mb-10 { margin-bottom: 18px !important; }
      header nav.md\:mb-14 { margin-bottom: 18px !important; }

      /* Hero title/desc lebih kecil */
      h1.text-3xl,
      h1.sm\:text-4xl,
      h1.lg\:text-5xl {
      ...
      /* Kartu stats: jadi 2 kolom + item ke-3 disembunyikan */
      .grid.grid-cols-2.sm\:grid-cols-3 {
        grid-template-columns: repeat(2, minmax(0, 1fr)) !important;
        gap: 10px !important;
      }
      .grid.grid-cols-2.sm\:grid-cols-3 > div:nth-child(3) {
        display: none !important; /* Non Formal hide di mobile */
      }

      /* Highlight card: padding & shadow lebih ringan */
      .shadow-card {
        box-shadow: 0 12px 28px rgba(15, 23, 42, 0.10) !important;
      }
      .rounded-3xl { border-radius: 22px !important; }
      .p-5 { padding: 14px !important; }
      .sm\:p-6 { padding: 14px !important; }
      .lg\:p-7 { padding: 14px !important; }

      /* Icon besar di highlight (yang hidden sm) tetap aman, tapi jaga-jaga */
      .hidden.sm\:flex.w-14.h-14 { display: none !important; }

      /* Kontak di highlight: tampilkan cuma 2 pertama */
      .grid.grid-cols-1.sm\:grid-cols-2 > div:nth-child(3),
      .grid.grid-cols-1.sm\:grid-cols-2 > div:nth-child(4) {
        display: none !important;
      }

      /* Divider & main wrapper: rapetin */
      .section-divider { height: 26px !important; }
      main.relative.-mt-10 { margin-top: -22px !important; }
      main.md\:-mt-16 { margin-top: -22px !important; }

      /* Container utama: padding lebih kecil */
      .bg-white.rounded-\[32px\] {
        border-radius: 22px !important;
        padding: 14px !important;
      }
      .sm\:p-7 { padding: 14px !important; }
      .lg\:p-8 { padding: 14px !important; }

      /* space-y-16 jadi lebih rapat */
      .space-y-16 > :not([hidden]) ~ :not([hidden]) {
        margin-top: 42px !important;
      }

      /* Judul section lebih kecil */
      h2.text-xl, h2.sm\:text-2xl {
        font-size: 18px !important;
        margin-bottom: 14px !important;
      }

      /* Card section: rapetin + matiin efek lompat */
      .rounded-2xl { border-radius: 18px !important; }
      .shadow-soft { box-shadow: 0 10px 22px rgba(15, 23, 42, 0.08) !important; }
      .hover\:shadow-card:hover { box-shadow: 0 10px 22px rgba(15, 23, 42, 0.08) !important; }
      .hover\:-translate-y-1:hover { transform: none !important; }

      /* Misi list: angka lebih kecil */
      .h-9.w-9 {
      ...
      /* Ekstrakurikuler card: padding kecil */
      .bg-gradient-to-br.p-5 { padding: 14px !important; }
      .text-xs.text-gray-600.mt-1 { margin-top: 6px !important; }

      /* Kurangi ornamen besar di hero */
      .hero-orbit { display: none !important; }
      .blur-pill { display: none !important; }
    }
  </style>
</head>
