                ...
                <x-slot name="header">
                    <div class="flex items-center justify-between w-full">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-lg font-bold text-gray-800 lowercase first-letter:uppercase">Daftar Artikel</h3>
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Kelola tulisan Anda</p>
                            </div>
                        </div>
        ...
        document.addEventListener('livewire:initialized', () => {
            Livewire.on('show-delete-confirmation', (data) => {
                Swal.fire({
                    ...
                    html: `<p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-4">Artikel "${data.name}" akan dihapus permanen. Tindakan ini tidak dapat dibatalkan.</p>`,
                    icon: 'warning',
