                ...
                <div class="p-8 space-y-8">
                    ...
                    <form id="artikel-form" action="{{ route('penulis.articles.update', $article) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="bg-gray-50 rounded-xl p-6 border">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="judul" id="judul" value="{{ old('judul', $article->judul) }}" required class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm">
                                </div>
                                <div class="md:col-span-2">
                                    <label for="category_id" class="block text-sm font-medium text-gray-700 mb-2">Kategori</label>
                                    <select name="category_id" id="category_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm">
                        ...
                        <div class="bg-gray-50 rounded-xl p-6 border"
                            ...
                            <template x-if="imageUrl">
                                <div class="mb-4">
                                    ...
                                    <div class="relative inline-block group">
                                        ...
                                        <div @click="imageUrl = ''; deleteImage = true; $refs.fileInput.value = ''; $refs.urlInput.value = ''"
                                            class="absolute top-0 right-0 m-2 bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity"
                                            title="Hapus Gambar">
                            ...
                            <div class="mb-4 border-b border-gray-200">
                                <nav class="-mb-px flex space-x-4" aria-label="Tabs">
                                    <button type="button" @click="activeTab = 'upload'; $refs.urlInput.value = ''"
                                            :class="{ 'border-[#059568] text-[#059568]': activeTab === 'upload', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'upload' }"
                                            class="whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm">
                                        Upload File
                                    </button>
                                    <button type="button" @click="activeTab = 'url'; $refs.fileInput.value = ''"
                                            :class="{ 'border-[#059568] text-[#059568]': activeTab === 'url', 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300': activeTab !== 'url' }"
                                            class="whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm">
                                        URL Gambar
                                    </button>
                                </nav>
                            ...
                            <div>
                                <div x-show="activeTab === 'upload'">
                                    ...
                                    <input type="file" name="gambar_upload" id="gambar_upload" x-ref="fileInput" @change="handleFileSelect"
                                ...
                                <div x-show="activeTab === 'url'" x-cloak>
                                    ...
                                    <div class="flex space-x-2">
                                        <input type="url" name="gambar_url" id="gambar_url" x-ref="urlInput"
                                               ...
                                               placeholder="https://..." class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm">
                        ...
                        <div class="bg-gray-50 rounded-xl p-6 border">
                            ...
                            <div id="editor">{!! old('isi', $article->isi) !!}</div>
                        </div>

                        <div class="flex justify-end space-x-4 pt-6 border-t">
                            <a href="{{ route('penulis.articles.index') }}" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200">Batal</a>
                            <button type="submit" class="px-6 py-3 bg-[#059568] text-white rounded-lg font-medium hover:bg-green-800 shadow-lg">Perbarui Artikel</button>
                        </div>
                    </form>
                </div>
            </div>
