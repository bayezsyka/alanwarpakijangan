        ...
        <nav class="grid grid-cols-3 items-center w-full">
            ...
            <div class="flex justify-center">
                <a href="{{ url('/') }}" class="flex items-center">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo Al-Anwar" class="h-10 w-auto" />
                </a>
            </div>
                ...
                <div class="relative group">
                    ...
                    <div id="dropdownNavbar"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                            ...
                            <li>
                                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Profil Pesantren</a>
                            </li>
                            <li>
