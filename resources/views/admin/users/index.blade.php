                    ...
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase">Tanggal
                                    Dibuat</th>
                                        ...
                                        @foreach ($user->roles ?? [] as $role)
                                            @php
                                                $roleLabels = [
                                                    'admin' => 'Admin',
                                                    'penulis' => 'Penulis',
                                                    'selasanan_manager' => 'Pengurus Selasanan',
                                                ];
                                                $roleColors = [
                                                    'admin' => 'bg-red-100 text-red-800',
                                                    'penulis' => 'bg-blue-100 text-blue-800',
                                                    'selasanan_manager' => 'bg-green-100 text-green-800',
                                                ];
                                            @endphp
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $roleColors[$role] ?? 'bg-gray-100 text-gray-800' }} mr-1">
