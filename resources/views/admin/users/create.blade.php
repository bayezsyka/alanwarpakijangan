<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <span class="text-sm font-black tracking-widest uppercase">Tambah Pengelola</span>
        </div>
    </x-slot>
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-8">
                ...
                @if ($errors->any())
                    <div class="bg-red-50 border border-red-100 p-5 rounded-2xl shadow-sm flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-sm font-black text-red-800 uppercase tracking-widest mb-1">Perbaikan Input</h3>
                        ...
                        <div class="bg-gray-50/50 p-6 rounded-3xl border border-gray-100 shadow-inner">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                <label class="relative flex flex-col items-center p-5 rounded-3xl border border-gray-200 bg-white hover:border-emerald-300 hover:shadow-xl hover:shadow-emerald-500/5 transition-all cursor-pointer group shadow-sm text-center">
                                    ...
                                    <p class="text-[9px] font-bold text-gray-400 mt-1 uppercase tracking-tighter">Akses Penuh Sistem</p>
                                </label>
                                ...
                                <label class="relative flex flex-col items-center p-5 rounded-3xl border border-gray-200 bg-white hover:border-blue-300 hover:shadow-xl hover:shadow-blue-500/5 transition-all cursor-pointer group shadow-sm text-center">
                                    ...
                                    <p class="text-[9px] font-bold text-gray-400 mt-1 uppercase tracking-tighter">Kelola Konten Artikel</p>
                                </label>
                ...
                <x-card>
                     <x-slot name="header">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-sm font-black text-gray-800 uppercase tracking-[0.2em]">Keamanan Kredensial</h3>
                        </div>
                    </x-slot>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label for="password" class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2">Password Login <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2">Konfirmasi Password <span class="text-red-500">*</span></label>
                            <div class="relative group">
