        ...
        <div class="bg-gradient-to-r from-[#059568] to-emerald-600 rounded-xl shadow-lg">
            <div class="px-8 py-6">
                ...
                <p class="text-emerald-100 mt-2">
                    Ubah pengaturan pengumuman popup di landing page.
                </p>
            </div>
        </div>
    </x-slot>
                ...
                <form action="{{ route('admin.announcements.update', $announcement) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                Biarkan kosong jika tidak ingin mengubah gambar. Max 2 MB.
                            </p>
                            @error('image')
                                <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" name="start_date"
                                       value="{{ old('start_date', $announcement->start_date->toDateString()) }}"
                                       class="block w-full rounded-lg border-gray-300 focus:ring-[#059568] focus:border-[#059568]">
                                @error('start_date')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" name="end_date"
                                       value="{{ old('end_date', $announcement->end_date->toDateString()) }}"
                                       class="block w-full rounded-lg border-gray-300 focus:ring-[#059568] focus:border-[#059568]">
                                @error('end_date')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
