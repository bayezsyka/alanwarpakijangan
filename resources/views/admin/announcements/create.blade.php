<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <span class="text-sm font-black tracking-widest uppercase">Input Pengumuman</span>
        </div>
    </x-slot>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" required
                                   placeholder="Contoh: Penerimaan Santri Baru 2024"
                        ...
                        <div>
                            ...
                            <p class="text-[9px] text-gray-400 mt-2 italic font-bold uppercase tracking-tighter">* Pengunjung akan diarahkan ke link ini saat mengklik visual pengumuman.</p>
                        </div>

                        <div class="bg-gray-50/50 p-6 rounded-3xl border border-gray-100 border-dashed">
                            <label for="image" class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4 text-center">Visual Pengumuman (Wajib) <span class="text-red-500">*</span></label>
                            <div class="flex flex-col items-center gap-5">
                                ...
                                <div class="text-center">
                                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Syarat Media:</p>
                                    <p class="text-[9px] font-bold text-gray-300 mt-1 uppercase tracking-tighter">Format JPG, PNG, WEBP (Maks 2MB)</p>
                                </div>
                            </div>
                    ...
                    <div class="space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date', $defaultStart) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date', $defaultEnd) }}"
                                           class="w-full px-4 py-3.5 bg-gray-50 border border-transparent rounded-2xl focus:bg-white focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all font-bold text-gray-900 outline-none shadow-sm">
                                </div>
                        ...
                        <div class="flex items-center p-5 bg-emerald-50/50 rounded-2xl border border-emerald-100 shadow-sm transition-all hover:bg-emerald-50 group">
                            ...
                            <div class="ml-4 text-sm">
                                ...
                                <p class="text-emerald-600/60 font-bold text-[10px] mt-0.5 uppercase tracking-tighter">Pesan akan segera tayang sesuai jadwal di atas</p>
                            </div>
                        </div>
                    </div>
                </x-card>
