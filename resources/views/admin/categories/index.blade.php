<x-app-layout>
    ...
    <div class="py-12"><div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-end mb-4"><a href="{{ route('admin.categories.create') }}" class="px-4 py-2 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition">+ Tambah Kategori</a></div>
                ...
                <tbody class="divide-y">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-center">{{ $category->articles_count }}</td>
                          <td class="px-6 py-4 text-sm"><a href="{{ route('admin.categories.edit', $category->id) }}" class="text-green-600 font-semibold hover:text-green-800">Ubah</a></td>
                    </tr>
                    @empty
